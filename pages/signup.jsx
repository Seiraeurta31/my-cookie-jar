    ...
    <div lang="en">
      ...
      <main lang="en" className={styles.main}>
        ...
        <Image alt="cookie jar logo" src="/cookieJarLogo.png" className={styles.logo} width="3000" height="1928"/>
          ...
          <h1 lang="en" className={styles.title}>Create an Account</h1>
          <form onSubmit={handleCreateAccount} className={styles.form}>

            <div className={styles.fieldContainer}>
              <label lang="en" htmlFor="firstName">First Name: </label>
              <input
            ...
            <div className={styles.fieldContainer}>
              <label lang="en" htmlFor="lastName">Last Name: </label>
              <input
                className={styles.inputBox}
                type="text"
                name="lastName"
            ...
            <div className={styles.fieldContainer}>
              <label lang="en" htmlFor="email">Email: </label>
              <input
                className={styles.inputBox}
                type="text"
                name="email"
            ...
            <div className={styles.fieldContainer}>
              <label lang="en" htmlFor="username">Username: </label>
              <input
                className={styles.inputBox}
                type="text"
                name="username"
            ...
            <div className={styles.fieldContainer}>
              <label lang="en" htmlFor="password">Password: </label>
              <input
                className={styles.inputBox}
                type="password"
                name="password"
            ...
            <div className={styles.fieldContainer}>
              <label lang="en" htmlFor="confirm-password">Confirm Password: </label>
              <input
                className={styles.inputBox}
                type="password"
            ...
            <button lang="en" className={styles.button} style={{ cursor: "pointer" }}>Submit</button>
          ...
          <div>
            <Link href="/login">
              <p lang="en" className={styles.logInLink}>Login instead?</p>
            </Link>
          </div>
